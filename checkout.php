...
<body>
    ...
    <?php
        ...
        if(isset($_POST['checkout'])){
            ...
            $sql= "insert into guest (id,name,email,tel,address,address2,city,state,postCode)
                   values ('{}','{$name}','{$email}','{$tel}','{$address}','{$address2}','{$city}','{$state}','{$postCode}')";
            $result = $conn->query($sql);
            
            if($result){
                $msg = "$name Successful order";
            }else{
                echo $conn->error;
            }
                ...
                <div class="col-12 col-md-6 col-lg-6">
                    <div class="card   border-top-0 border-left-0">
                        <div class="card-body">
                            ...
                            <a href="#" type="button"  onclick="show5()" class="btn btn-sm btn-secondary">Login</a> 
                          </div>
                              ...
                              <div class="form-check">
                                ...
                                <div id="div1" class="hide" style="display:none;">
                                        ...
                                        <div>
                                            <input type="text" class="form-control form-control-sm" id="guestName" placeholder="Name" name="name">
                                        </div>
                                      </div>
                                         <div class="form-group ">
                                        <label for="guestEmail">Email</label>
                                        <div >
                                            <input type="email" class="form-control form-control-sm" id="guestEmail" placeholder="Email" name="email">
                                        </div>
                                      </div>
                                         <div class="form-group ">
                                        <label for="guestTel">Tel</label>
                                        <div >
                                            <input type="tel" class="form-control form-control-sm" id="guestTel" placeholder="Tel" pattern="^(\+?6?01)[0-46-9]-*[0-9]{7,8}$" name="tel">
                                        </div>
                                      </div>
                                         ...
                                         <div class="form-group">
                                            ...
                                            <div >
                                                <input type="text" class="form-control" id="inputAddress" placeholder="Address1" name="address">
                                            </div>
                                          </div>
                                          <div class="form-group">
                ...
                <div class="col-12 col-md-6 col-lg-6">
                    <div class="card border-top-0 border-left-0">
                        <div class="card-body">
                            ...
                            <div class="form-check">
                            <input class="form-check-input" type="radio" name="payment" id="payment2" value="option2" onclick="show3()" >
